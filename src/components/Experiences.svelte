...
<div class="experiences-container">
    ...
    <main class="flex flex-col flex-1 p-4">
        <div class="experience-card group relative">
            ...
            <h3 class="font-semibold text-m sm:text-l md:text-xl mt-3">
                I presently serve the noble guild <a
                    ...
                    ></span></a
                > as a humble artisan. Under their guidance, I initially employed
                the sorcery of GDScript, but we have since embraced the ancient powers
                of Odin to forge their grand interactive tapestry.
            </h3>
        ...
        <div class="experience-card group relative mt-8">
            ...
            <h3 class="font-semibold text-m sm:text-l md:text-xl mt-3">
                I serve as an apprentice in the crafting of a Telegram-bound
                construct that treads only the lands of Solana. This tool grants
                folk the means to trade coin and token with modest swiftness, to
                place orders, mirror the dealings of others, keep account of
                their holdings, and see their standing among their peers.
            </h3>
            <h3 class="text-s sm:text-m md:text-l mt-2 text-violet-200/80">
                July 2025 - Present
            </h3>
        ...
        <div class="experience-card group relative mt-8">
            ...
            <h3 class="font-semibold text-m sm:text-l md:text-xl mt-3">
                I bestow my craft upon the scrolls of open knowledge, forging
                arcane instruments for the benefit of the realm's denizens. I
                have unleashed mystic artifacts known as NeuraTalk and
                Drawniverse, endowing others with enchanted implements of
                artificial wisdom and vessels for creative expression.
            </h3>
            <h3 class="text-s sm:text-m md:text-l mt-2 text-violet-200/80">
                May 2023 - Present
            </h3>
        ...
        <div class="experience-card group relative mt-8">
            ...
            <h3 class="font-semibold text-m sm:text-l md:text-xl mt-3">
                My journey in the arcane arts commenced in the fifth cycle of
                scholarly tutelage, when I first gazed upon the mystic runes of
                C#. Following a period of repose to prepare for the Great Trials
                of Academic Entrance, I resumed my pursuit of enlightenment with
                the enigmatic sigils of Go (Golang). I persistently cultivate my
                abilities through solitary study of ancient tomes and the
                forging of practical enchanted artifacts.
            </h3>
            <h3 class="text-s sm:text-m md:text-l mt-2 text-violet-200/80">
                2018 - Present
            </h3>
