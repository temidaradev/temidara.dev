<!-- <footer class="py-20 sm:py-32 flex flex-col gap-4 sm:gap-8 justify-center items-center">
  ...
  <div class="flex flex-col gap-4 items-center justify-center">
    ...
    <p><b class="pr-2">Email</b>ahmet.affan.ebcioglu@outlook.com</p>
    <p>
      <b class="pr-2">GitHub</b>
      <a href="https://github.com/temidaradev" target="_blank" class="text-violet-400"
        >temidaradev<sup class=""
